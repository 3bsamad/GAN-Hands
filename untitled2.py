# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 02:06:50 2020
...
def build_discriminator(image_shape):
    ...
    model.add(Conv2D(32, kernel_size=5, strides=2, input_shape=image_shape, 
                     padding="same"))
...
#Optimizers
generator_optimizer = tf.keras.optimizers.Adam(0.0008,0.5)
discriminator_optimizer = tf.keras.optimizers.Adam(0.0004,0.5)


#generator_optimizer = tf.keras.optimizers.RMSprop(learning_rate=0.0008, clipvalue=1.0, decay=6e-8)


#discriminator_optimizer = tf.keras.optimizers.RMSprop(learning_rate=0.0004, clipvalue=1.0, decay=3e-8)
